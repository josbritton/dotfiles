...
# nag to use C-d more, remove when no longer needed
_exit() {
    notify-send "Interactive exit" "Use <b>Ctrl+d</b> instead of the exit command"
}
alias exit=_exit

# nag to use C-l more, remove when no longer needed
_clear() {
    notify-send "clear command" "Use <b>Ctrl+l</b> instead of the clear command"
}
alias clear=_clear
